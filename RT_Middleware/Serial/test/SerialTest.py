...
serialtest_spec = ["implementation_id", "SerialTest",
		 "type_name",         "SerialTest",
...
#
#
class SerialTest(OpenRTM_aist.DataFlowComponentBase):
...
def SerialTestInit(manager):
    profile = OpenRTM_aist.Properties(defaults_str=serialtest_spec)
    manager.registerFactory(profile,
                            SerialTest,
                            OpenRTM_aist.Delete)

def MyModuleInit(manager):
    SerialTestInit(manager)

    # Create a component
    comp = manager.createComponent("SerialTest")
